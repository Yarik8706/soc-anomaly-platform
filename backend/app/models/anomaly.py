...
class Anomaly(Base):
    ...
    score_isolation_forest: Mapped[float | None] = mapped_column(Float, nullable=True)
    score_isolation_forest_norm: Mapped[float | None] = mapped_column(Float, nullable=True)
    rank_isolation_forest: Mapped[int | None] = mapped_column(Integer, nullable=True)
    score_lof: Mapped[float | None] = mapped_column(Float, nullable=True)
    score_lof_norm: Mapped[float | None] = mapped_column(Float, nullable=True)
    rank_lof: Mapped[int | None] = mapped_column(Integer, nullable=True)
    score_combined: Mapped[float | None] = mapped_column(Float, nullable=True)
    rank_combined: Mapped[int | None] = mapped_column(Integer, nullable=True)
